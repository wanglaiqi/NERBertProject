...
from NERBertProject.bert import optimization
from NERBertProject.bert import tokenization
from NERBertProject.bert import tf_metrics
...
from NERBertProject.model.lstm_crf_layer import BLSTM_CRF
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(label_ids, pred_ids):
                precision = tf_metrics.precision(label_ids, pred_ids, 10, [1, 2, 3, 4, 5, 6], average="macro")
                recall = tf_metrics.recall(label_ids, pred_ids, 10, [1, 2, 3, 4, 5, 6], average="macro")
                f = tf_metrics.f1(label_ids, pred_ids, 10, [1, 2, 3, 4, 5, 6], average="macro")
